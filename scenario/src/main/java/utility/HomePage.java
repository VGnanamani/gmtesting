...
public class HomePage {
	...
	@FindBy(xpath="/descendant::input[@aria-label='Description' and @type='text'][1]")
	WebElement txtsearchDescription;
	...
	@FindBy(xpath="/descendant::input[@type='checkbox'][1]")
	WebElement chkAll;
	

	@FindBy(xpath="//*[@id='reportingManage']/div[1]/div/a[6]")
	...
	public void search_template_Delete(String TemplateName, String Description, String Username) throws InterruptedException {
		
     Thread.sleep(10000);
	    
	    txtName.clear();
	    
		txtName.sendKeys(TemplateName);
		
				
		txtsearchDescription.clear();
		
		txtsearchDescription.sendKeys(Description);
